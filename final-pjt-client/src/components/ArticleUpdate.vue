      ...
      <div class="mx-5 px-5">
        <div class="mx-5 px-5">
          <b-form @submit="onSubmit" @reset="onReset" v-if="show">
            ...
            <b-button variant="primary" @click="createArticle">Update</b-button>
...
export default {
  ...
  created: function () {
    ...
    this.article.rate = this.$route.query.article.rate
    this.article.content = this.$route.query.article.content
    this.article.genre = this.$route.query.article.genre
  }
}
</script>
